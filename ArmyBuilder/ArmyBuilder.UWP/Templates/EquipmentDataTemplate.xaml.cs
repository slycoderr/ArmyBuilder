...
namespace ArmyBuilder.Templates
{
    public sealed partial class EquipmentDataTemplate : ResourceDictionary
    {
        ...
        private void WholeRuleCheckBox_Checked(object sender, RoutedEventArgs e)
        {
        ...
        private void CheckBox_DataContextChanged(FrameworkElement sender, DataContextChangedEventArgs e)
        {
    ...
    public class EquipmentGroupPreTextConverter : IValueConverter
    {
        public object Convert(object value, Type type, object parameter, string language)
        {
            ...
            else if (group.GroupFlag == GroupFlag.ByMutualIdAndReplaceId)
            {
                if (group.SelectMany(e=>e.EquipmentInfo.Profile.ReplacesIdList).All(id=>id == -1))
                {
        ...
        public object Convert(object value, Type type, object parameter, string language)
        {
            ...
            else if (group.GroupFlag == GroupFlag.ByMutualIdAndReplaceId)
            {
                if (group.SelectMany(e => e.EquipmentInfo.Profile.ReplacesIdList).All(id => id != -1))
                {
                    ...
                    return "with any  of the following";
                }
            }
    ...
    public class ForceOrgTextConverter : IValueConverter
    {
        public object Convert(object value, Type type, object parameter, string language)
        {
            var forceOrgSlot = (ForceOrgSlot) (int) value;
