...
namespace ArmyBuilder.Core.Models
{
    ...
    public class UnitEntry : BindableBase
    {
        ...
        /// </summary>
        [XmlAttribute]
        public int MaxUnitSize { get => maxUnitSize; set => SetValue(ref maxUnitSize, value); }

        [XmlAttribute]
        public string Name { get => name; set => SetValue(ref name, value); }

        [XmlAttribute]
        public ForceOrgSlot ForceOrgSlot { get => forceOrgSlot; set => SetValue(ref forceOrgSlot, value); }
